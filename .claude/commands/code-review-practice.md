...
argument-hint: TYPE=angular|spring-boot|sql|all [DIFFICULTY=standard] [ISSUE_COUNT=4] [FOCUS=...]
---
...
Rules:
- Named `/code-review-practice` because `/code-review` is Claude Code's own diff review — different tool, do not confuse them.
