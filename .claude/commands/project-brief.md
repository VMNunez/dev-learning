---
description: Decide the next project and record why, as a durable one-page brief (orchestrator, runs inside Claude Code)
argument-hint: [NUMBER=08] [CANDIDATE=name]
---

Read `notes/prompts/projects/plan/project-brief-prompt.md` and execute it in full as the hands-off orchestrator it describes, running inside Claude Code.
