---
description: Close the gaps between a topic's study notes and its interview Q&A so both sides agree (runs inside Claude Code)
argument-hint: TOPIC=Angular|SQL|Java|...|all  (NOTES_PATH and FILE derived from TOPIC)
---

Read `notes/prompts/knowledge/interview-prep/notes-and-interview-prep-prompt.md` and execute it in full, running inside Claude Code.
