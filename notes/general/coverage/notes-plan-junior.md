...
Coverage SHA-256: ed0bb22140c57345c041be9f6f7357d3e4c2151928f8c1a17decb1acb77932b7
Generated: 2026-07-24

## 01 — HTTP methods and request structure

Status: pending
Action: audit
English: notes/general/junior/en/01-http-fundamentals.md
Spanish: notes/general/junior/es/01-http-fundamentals.md
Depends on: none
...
Rationale: These concepts form the coherent coverage group “HTTP methods and request structure, HTTP status codes”.

## 02 — JSON and serialization

Status: pending
Action: audit
English: notes/general/junior/en/02-json.md
Spanish: notes/general/junior/es/02-json.md
Depends on: 01
...
Rationale: These concepts form the coherent coverage group “JSON and serialization”.

## 03 — Error handling

Status: pending
Action: audit
English: notes/general/junior/en/05-error-handling.md
Spanish: notes/general/junior/es/05-error-handling.md
Depends on: 02
...
Status: pending
Action: audit
English: notes/general/junior/en/08-testing-concepts.md
Spanish: notes/general/junior/es/08-testing-concepts.md
Depends on: 03
...
Rationale: These concepts form the coherent coverage group “Software testing”.

## 05 — Browser storage

Status: pending
Action: audit
English: notes/general/junior/en/07-browser-storage.md
Spanish: notes/general/junior/es/07-browser-storage.md
Depends on: 04
...
Rationale: These concepts form the coherent coverage group “Browser storage”.

## 06 — Environment variables

Status: pending
Action: audit
English: notes/general/junior/en/03-environment-variables.md
Spanish: notes/general/junior/es/03-environment-variables.md
Depends on: 05
...
Rationale: These concepts form the coherent coverage group “Environment variables”.

## 07 — Containerisation (Docker)

Status: pending
Action: audit
English: notes/general/junior/en/10-docker.md
Spanish: notes/general/junior/es/10-docker.md
Depends on: 06
...
Rationale: These concepts form the coherent coverage group “Containerisation (Docker)”.

## 08 — Base64

Status: pending
Action: audit
English: notes/general/junior/en/04-base64.md
Spanish: notes/general/junior/es/04-base64.md
Depends on: 07
...
Rationale: These concepts form the coherent coverage group “Base64”.

## 09 — Logging

Status: pending
Action: audit
English: notes/general/junior/en/11-logging.md
Spanish: notes/general/junior/es/11-logging.md
Depends on: 08
...
Rationale: These concepts form the coherent coverage group “Logging”.

## 10 — Code principles

Status: pending
Action: audit
English: notes/general/junior/en/09-code-principles.md
Spanish: notes/general/junior/es/09-code-principles.md
Depends on: 09
...
Rationale: These concepts form the coherent coverage group “Code principles”.

## 11 — Agile and delivery awareness

Status: pending
Action: create
English: notes/general/junior/en/13-agile-and-delivery-awareness.md
Spanish: notes/general/junior/es/13-agile-and-delivery-awareness.md
Depends on: 10
...
Rationale: These concepts form the coherent coverage group “Agile and delivery awareness”.

## Unassigned existing notes

- notes/general/junior/en/06-solid.md — no junior coverage group is assigned to this legacy file.
- notes/general/junior/en/12-debugging.md — no junior coverage group is assigned to this legacy file.
