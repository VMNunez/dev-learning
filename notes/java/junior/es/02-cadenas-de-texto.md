...
A continuación se enumeran los pasos que hay detrás de toda llamada a `toLowerCase()` o `toUpperCase()` sin argumento; los dos métodos se comportan igual. Los dos primeros pasos ocurren una sola vez, cuando arranca el programa; los dos últimos ocurren en cada llamada:
