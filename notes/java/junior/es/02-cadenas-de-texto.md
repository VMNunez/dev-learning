...
Esta es la cadena que hay detrás (TODO: NO ME GUSTA "Esta es la cadena que hay detrás". MEJOR DECIR QUE A CONTINUACION SE ENUMERAN LOS PASOS QUE HAY DETRAS DE TODA LLAMADA A TOLOWERCASE O TOUPPERCASE(HE AÑADIDO UPPERCASE PORQUE IMAGINO QUE SE COMPORTA IGUAL Y TU SOLAMENTE ME PONES TOLOWERCASE Y ME CONFUNDE))de toda llamada a `toLowerCase()` sin argumento. Los dos primeros pasos ocurren una sola vez, cuando arranca el programa; los dos últimos ocurren en cada llamada:
