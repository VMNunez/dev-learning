...
Con esto ya has visto entero el modelo de valores de Java: los ocho primitivos y los objetos wrapper a su lado, las conversiones que el compilador hace por ti y las que te obliga a escribir, `BigDecimal` para valores que tienen que ser exactos, los operadores que usas para las distintas operaciones, y `var`, que cambia cómo _escribes_ el tipo pero no el tipo que la variable acaba teniendo.
