...
| -------------------------- | --------------------------------------------------------------------------------------------------------- | ----------------------- |
| `@Configuration`           | Marks this class as a source of Spring beans — a place where `@Bean` methods may live                     | [03-dependency-injection.md](./03-dependency-injection.md) — you write your own `@Configuration` class there |
...
| `@ComponentScan`           | Scans the current package and all sub-packages for `@Component`, `@Service`, `@Repository`, `@Controller` | The scan step by step is in [00-intro-spring-boot.md](./00-intro-spring-boot.md); the beans it finds are the `@RestController` of [02-rest-controllers.md](./02-rest-controllers.md) and the `@Repository` of [04-spring-data-jpa.md](./04-spring-data-jpa.md) |
