...
Those three gaps have names. Two of them — correlation ids and the connection pool — are already parked in [`notes/spring-boot/future-learning.md`](../future-learning.md); the third belongs beside them:
