...
This is `notes/spring-boot/en/../../projects/07-timetrack/backend/timetrack/src/main/java/com/victor/timetrack/repository/TimeEntrySpecifications.java` in project 07 — one static factory method per filter:
