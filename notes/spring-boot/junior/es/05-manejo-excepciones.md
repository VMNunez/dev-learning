...
La distinción comprobada/no comprobada en sí, y qué hace el compilador con cada una, está en [java/11-excepciones.md](../../../java/junior/es/11-excepciones.md) — el patrón es el mismo, aplicado aquí a la capa de la REST API.
