...
The checked/unchecked distinction itself, and what the compiler does with each, is in [java/11-exceptions.md](../../../java/junior/en/11-exceptions.md) — the pattern is the same, applied here to the REST API layer.
