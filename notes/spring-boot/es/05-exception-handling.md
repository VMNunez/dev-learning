...
Cuando `@Valid` en un `@RequestBody` falla, Spring lanza `MethodArgumentNotValidException`. Gestíonalo en `@ControllerAdvice` para devolver errores a nivel de campo:
