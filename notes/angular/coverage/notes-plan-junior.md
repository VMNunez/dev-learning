...
Coverage SHA-256: a22f33f6a38c3954de6c9ec4402ca0aab3fb12461787675379c6c34fef7e2984
...
Handoff: Local state is ready to represent remote work; chapter 07 connects it to typed HTTP requests and explicit UI states.
...
- What does the async pipe consume, and why will chapter 09 own its subscription semantics?
...
Handoff: With the pipe concept established, chapter 08 can use async pipe terminology while introducing remote HTTP state.
