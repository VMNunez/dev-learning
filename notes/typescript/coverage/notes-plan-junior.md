...
Coverage SHA-256: 24d4f00d16332a0cf76773628ad3fffa70cfd46228e24827d2fb07f4b82be710
...
Status: pending
Action: audit
English: notes/typescript/junior/en/02-types-interfaces.md
Spanish: notes/typescript/junior/es/02-types-interfaces.md
Depends on: none
...
Rationale: These concepts form the coherent coverage group “Types, Interfaces and type aliases, Utility types, Null safety and type assertions”.

## 02 — Enums

Status: pending
Action: audit
English: notes/typescript/junior/en/04-enums.md
Spanish: notes/typescript/junior/es/04-enums.md
Depends on: 01
...
Status: pending
Action: audit
English: notes/typescript/junior/en/03-generics.md
Spanish: notes/typescript/junior/es/03-generics.md
Depends on: 02
...
Status: pending
Action: audit
English: notes/typescript/junior/en/05-type-narrowing.md
Spanish: notes/typescript/junior/es/05-type-narrowing.md
Depends on: 03
...
Rationale: These concepts form the coherent coverage group “Narrowing and type guards”.

## 05 — Classes and access modifiers

Status: pending
Action: audit
English: notes/typescript/junior/en/06-access-modifiers.md
Spanish: notes/typescript/junior/es/06-access-modifiers.md
Depends on: 04
...
Rationale: These concepts form the coherent coverage group “Classes and access modifiers”.

## 06 — `as const`

Status: pending
Action: audit
English: notes/typescript/junior/en/07-as-const.md
Spanish: notes/typescript/junior/es/07-as-const.md
Depends on: 05
...
Rationale: These concepts form the coherent coverage group “`as const`”.

## 07 — Arrow functions and functions

Status: pending
Action: create
English: notes/typescript/junior/en/08-arrow-functions-and-functions.md
Spanish: notes/typescript/junior/es/08-arrow-functions-and-functions.md
Depends on: 06
...
Rationale: These concepts form the coherent coverage group “Arrow functions and functions”.

## 08 — Modules and decorators

Status: pending
Action: create
English: notes/typescript/junior/en/09-modules-and-decorators.md
Spanish: notes/typescript/junior/es/09-modules-and-decorators.md
Depends on: 07
...
Rationale: These concepts form the coherent coverage group “Modules and decorators”.

## Unassigned existing notes

- notes/typescript/junior/en/01-typescript-utilities.md — no junior coverage group is assigned to this legacy file.
