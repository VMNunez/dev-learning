...
Status: pending
Action: create
English: notes/css/junior/en/18-box-model.md
Spanish: notes/css/junior/es/18-box-model.md
Depends on: none
...
Rationale: These concepts form the coherent coverage group “Box model”.

## 02 — Display and layout

Status: pending
Action: audit
English: notes/css/junior/en/16-layout-patterns.md
Spanish: notes/css/junior/es/16-layout-patterns.md
Depends on: 01
...
Rationale: These concepts form the coherent coverage group “Display and layout”.

## 03 — Angular-specific CSS

Status: pending
Action: audit
English: notes/css/junior/en/10-css-functions.md
Spanish: notes/css/junior/es/10-css-functions.md
Depends on: 02
...
Rationale: These concepts form the coherent coverage group “Angular-specific CSS, CSS functions”.

## 04 — Selectors and specificity

Status: pending
Action: audit
English: notes/css/junior/en/04-selectors.md
Spanish: notes/css/junior/es/04-selectors.md
Depends on: 03
...
Rationale: These concepts form the coherent coverage group “Selectors and specificity”.

## 05 — Flexbox

Status: pending
Action: audit
English: notes/css/junior/en/11-flexbox.md
Spanish: notes/css/junior/es/11-flexbox.md
Depends on: 04
...
Rationale: These concepts form the coherent coverage group “Flexbox”.

## 06 — CSS Grid

Status: pending
Action: audit
English: notes/css/junior/en/12-grid.md
Spanish: notes/css/junior/es/12-grid.md
Depends on: 05
...
Rationale: These concepts form the coherent coverage group “CSS Grid”.

## 07 — Position

Status: pending
Action: audit
English: notes/css/junior/en/14-positioning.md
Spanish: notes/css/junior/es/14-positioning.md
Depends on: 06
...
Rationale: These concepts form the coherent coverage group “Position”.

## 08 — Responsive design

Status: pending
Action: audit
English: notes/css/junior/en/13-responsive-design.md
Spanish: notes/css/junior/es/13-responsive-design.md
Depends on: 07
...
Rationale: These concepts form the coherent coverage group “Responsive design”.

## 09 — Units

Status: pending
Action: audit
English: notes/css/junior/en/02-units.md
Spanish: notes/css/junior/es/02-units.md
Depends on: 08
...
Rationale: These concepts form the coherent coverage group “Units”.

## 10 — Transitions and animations

Status: pending
Action: audit
English: notes/css/junior/en/15-transitions-animations.md
Spanish: notes/css/junior/es/15-transitions-animations.md
Depends on: 09
...
Rationale: These concepts form the coherent coverage group “Transitions and animations”.

## 11 — Typography

Status: pending
Action: audit
English: notes/css/junior/en/07-typography.md
Spanish: notes/css/junior/es/07-typography.md
Depends on: 10
...
Rationale: These concepts form the coherent coverage group “Typography”.

## 12 — CSS variables

Status: pending
Action: audit
English: notes/css/junior/en/01-reset-variables.md
Spanish: notes/css/junior/es/01-reset-variables.md
Depends on: 11
...
Rationale: These concepts form the coherent coverage group “CSS variables”.

## 13 — Colors and transparency

Status: pending
Action: audit
English: notes/css/junior/en/03-colors-opacity.md
Spanish: notes/css/junior/es/03-colors-opacity.md
Depends on: 12
...
Rationale: These concepts form the coherent coverage group “Colors and transparency”.

## 14 — Borders, shadows, and backgrounds

Status: pending
Action: audit
English: notes/css/junior/en/08-borders-shadows.md
Spanish: notes/css/junior/es/08-borders-shadows.md
Depends on: 13
...
Rationale: These concepts form the coherent coverage group “Borders, shadows, and backgrounds”.

## 15 — Overflow

Status: pending
Action: audit
English: notes/css/junior/en/17-common-tricks.md
Spanish: notes/css/junior/es/17-common-tricks.md
Depends on: 14
...
Rationale: These concepts form the coherent coverage group “Overflow”.

## 16 — BEM naming

Status: pending
Action: audit
English: notes/css/junior/en/06-bem-naming.md
Spanish: notes/css/junior/es/06-bem-naming.md
Depends on: 15
...
Rationale: These concepts form the coherent coverage group “BEM naming”.

## Unassigned existing notes

- notes/css/junior/en/05-specificity.md — no junior coverage group is assigned to this legacy file.
- notes/css/junior/en/09-backgrounds.md — no junior coverage group is assigned to this legacy file.
