...
**Internal component. Not runnable.** Twelve of the 29 runnable prompts end by executing this step; the
other seventeen end by executing `_pipeline-self-report.md`. Same purpose: each real run
