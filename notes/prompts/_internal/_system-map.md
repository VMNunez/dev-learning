...
- **The heaviest block has the least structure.** 08:00 carries more ritual contract than the other
  ...
  backlog task therefore walks four skills and 10 + 7 + 7 + 6 declared steps** — the longest single path
  in the system.
