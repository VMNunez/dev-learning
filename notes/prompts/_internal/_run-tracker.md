...
| Java | 2026-07-26 — completed — 120 items; consumed 4 verify gaps (fast path); mirror parity; notes plan stale | 2026-07-26 — superseded — 4 gaps consumed by coverage-prompt; re-verify pending | 2026-07-26 — blocked — Guard 5: verify-junior superseded, SHA stale vs current coverage; run coverage-verify | 0/15 complete — blocked | | | | | | | | | | | | | | |
| Architecture | | | | | | | | | | | | | | | | | | |
| Security | | | | | | | | | | | | | | | | | | |
| TypeScript | | | | | | | | | | | | | | | | | | |
| JavaScript | | | | | | | | | | | | | | | | | | |
