...
|---|---|---|---|---|---|
| 01-todo-list | | | 2026-07-14 (frontend only — Angular-only project; backfilled 2026-08-06) | 2026-08-29 (global only — Angular-only project; FIXED, README changed) | 2026-08-29 (completed — ✅ Ready; 79 questions; dry run — outputs committed by hand, CV bullet chosen and re-polished outside the run) ⚠ stale — bank predates the `en/`+`es/` pair and the identity rules (both 2026-08-31) and the priority markers (2026-09-05): the 79 questions owe their Spanish twin, their `01-todo-list-NNN` IDs and their `⭐⭐⭐`/`⭐⭐`/`⭐` markers, all three discharged by the next `/portfolio-audit projects/01-todo-list`, whose own counts of ID-less and marker-less questions are what carry the debt forward |
