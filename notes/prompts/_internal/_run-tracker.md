...
| Security | | | | | | | | | | | | | | | | | | |
| TypeScript | | | | | | | | | | | | | | | | | | |
| JavaScript | 2026-07-29 — completed — 128 items; verify-gap fast path; 5 gaps consumed; mirror parity; notes-plan refresh next | 2026-07-29 — completed — 5 gaps; SHA f35c4540; findings consumed by coverage update | | | | | | | | | | | | | | | | |
| CSS | | | | | | | | | | | | | | | | | | |
