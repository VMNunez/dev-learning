...
| Java | junior | 03 | `notes/java/junior/en/03-control-flow.md` | `notes/java/junior/es/03-flujo-de-control.md` | complete | 2026-08-26 | completed — audit under the 2026-08-26 plan; 6/6 concepts `[x]`; en 483→508, es 483→506, 16 headings parity; `## Null checks` consolidated to a marked forward reference per entry 04's audit note; `### Choosing between the four loop forms` and `### return` written; `Studied: pending` preserved; four stages passed |
