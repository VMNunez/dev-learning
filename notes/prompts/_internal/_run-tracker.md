...
| 04-meal-finder | | | 2026-07-14 (frontend only — Angular-only project; backfilled 2026-08-06) | 2026-09-02 (global only — Angular-only project; completed — first run with the `REC-197` reader-effect judge: author FIXED, cold reviewer PASS/unchanged, judge returned 10 items, applier B applied all 10 with zero rejections; README changed) | |
