...
| Java | junior | 03 | `notes/java/junior/en/03-control-flow.md` | `notes/java/junior/es/03-flujo-de-control.md` | pending | 2026-08-26 | blocked — guard 5: coverage SHA-256 `8c66ee9b` ≠ plan `b8216257` after a junior bullet landed today; run `notes-plan-prompt` for Java junior; 0/4 stages dispatched |
