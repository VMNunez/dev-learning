...
**One workable row, plus `REC-054` accruing.** The first `/system-gaps` run's five rows
...
**Current order: `REC-100`, alone on the table.** `REC-107` closed
...
`REC-100` now runs alone — its batch partner closed first and took the shared family sweep
