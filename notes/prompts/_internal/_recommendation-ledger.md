...
**Current order: nothing queued** — the workable table is empty, so the next row comes from a run
rather than from this file. Four rules ordered the waves that drained this table
