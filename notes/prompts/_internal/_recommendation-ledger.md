...
precedence block —
`REC-120`, `REC-122`, `REC-123`, `REC-126`, `REC-128`,
`REC-129`, `REC-130`, `REC-138`, `REC-139`, `REC-141`, `REC-142`, `REC-143`, `REC-144`, `REC-145`,
`REC-147` and `REC-150`** — sixteen rows, `REC-149`, `REC-112` and `REC-113` having closed after this block produced it and `REC-150` having replaced the last of them. `REC-109` led this order
