...
precedence block —
`REC-113`, `REC-120`, `REC-122`, `REC-123`, `REC-126`, `REC-128`,
`REC-129`, `REC-130`, `REC-138`, `REC-139`, `REC-141`, `REC-142`, `REC-143`, `REC-144`, `REC-145` and
`REC-147`** — sixteen rows, `REC-149` and `REC-112` having closed after this block produced it. `REC-109` led this order
