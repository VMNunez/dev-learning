...
rows raised by `/system-gaps` on 2026-08-11. Two remain after `REC-096` closed.**
...
**Current order: `REC-097` → `REC-098`.** Walk the two provenance findings in the ranking
`/system-gaps` assigned; do not batch
