...
`REC-147`, `REC-150`, `REC-151`, `REC-152` and `REC-153`** — twelve rows, `REC-120` having closed after this block produced it and raised `REC-151` in its place, `REC-123` having closed and raised `REC-152`, `REC-142` having closed and raised `REC-153` the same way, and `REC-122`, `REC-126`, `REC-128` and `REC-129` having closed without raising one. `REC-109` led this order
