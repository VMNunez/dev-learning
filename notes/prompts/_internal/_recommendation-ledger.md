...
**Current order: safety, persistent-state risks and broken or undefined terminal paths are all drained.
Authority and writer boundaries `REC-134`,
`REC-135`; then the remaining bounded schema, read-scope and precedence rows `REC-110`,
