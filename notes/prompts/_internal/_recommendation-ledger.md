...
`REC-147`, `REC-150`, `REC-151` and `REC-153`** — eleven rows, `REC-120` having closed after this block produced it and raised `REC-151` in its place, `REC-123` having closed and raised `REC-152`, `REC-142` having closed and raised `REC-153` the same way, and `REC-122`, `REC-126`, `REC-128`, `REC-129` and `REC-152` having closed without raising one — `REC-152` being the first of this block's own rows to drain rather than replace itself. `REC-109` led this order
