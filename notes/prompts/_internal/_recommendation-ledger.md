...
precedence block —
`REC-130`, `REC-138`, `REC-139`, `REC-141`, `REC-142`, `REC-143`, `REC-144`, `REC-145`,
`REC-147`, `REC-150`, `REC-151` and `REC-152`** — twelve rows, `REC-120` having closed after this block produced it and raised `REC-151` in its place, `REC-123` having closed and raised `REC-152` the same way, and `REC-122`, `REC-126`, `REC-128` and `REC-129` having closed without raising one. `REC-109` led this order
