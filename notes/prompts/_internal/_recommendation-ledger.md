...
precedence block —
`REC-123`, `REC-126`, `REC-128`,
`REC-129`, `REC-130`, `REC-138`, `REC-139`, `REC-141`, `REC-142`, `REC-143`, `REC-144`, `REC-145`,
`REC-147`, `REC-150` and `REC-151`** — fifteen rows, `REC-120` having closed after this block produced it and raised `REC-151` in its place, and `REC-122` having closed without raising one. `REC-109` led this order
