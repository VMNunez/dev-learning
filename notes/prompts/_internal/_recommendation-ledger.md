...
`REC-147`, `REC-150`, `REC-151` and `REC-152`** — fifteen rows, `REC-120` having closed after this block produced it and raised `REC-151` in its place, `REC-123` having closed and raised `REC-152` the same way, and `REC-122` having closed without raising one. `REC-109` led this order
