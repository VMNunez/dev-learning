...
precedence block —
`REC-141`, `REC-143`, `REC-144`, `REC-145`,
`REC-147`, `REC-151` and `REC-153`** — seven rows, `REC-120` having closed after this block produced it and raised `REC-151` in its place, `REC-123` having closed and raised `REC-152`, `REC-142` having closed and raised `REC-153` the same way, and `REC-122`, `REC-126`, `REC-128`, `REC-129`, `REC-130`, `REC-138`, `REC-139`, `REC-150` and `REC-152` having closed without raising one — `REC-152` was the first of this block's own rows to drain rather than replace itself, `REC-150` the second, `REC-130` the third, `REC-138` the fourth and `REC-139` the fifth, which puts the table five rows below where the block started. `REC-109` led this order
