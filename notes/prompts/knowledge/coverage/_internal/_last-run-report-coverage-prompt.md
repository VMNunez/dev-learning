...
- **Verdict** — Change applied: reserve `FIRST_RUN` for an admitted, empty junior topic; existing coverage uses normal recalibration, and middle/senior cannot initialize a topic. Cold reviewer: approve-with-tightening.
