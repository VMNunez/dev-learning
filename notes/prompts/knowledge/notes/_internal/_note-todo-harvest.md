...
| NTH-0009 | 2026-09-04 | java/junior/01 | es | tabla-sin-uso-real | 7 | ME GUSTARIA UNA COLUMNA QUE PUSIERA EL USO HABITUAL / CREO QUE SI A ES FALSE A && B ES FALSE SIN IMPORTAR LO QUE SEA B … (tabla de verdad) / SI A ES FALSE Y B ES FALSE A || B … / PREFIERO DOS TABLAS SEPARADAS / ESO ES EL CORTOCIERTUITO. CUANDO SE VA A USAR ESTO? (x2) / PODRIAS NOMBRAR LAS CLASES WRAPPER INCLUSO HACER UNA TABLA | missing | — | open |
