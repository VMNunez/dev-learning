...
| NTH-0029 | 2026-09-08 | java/junior/02 | es | frase-sobrecargada | 5 | NO ME GUSTA TU FORMA DE EXPRESAR "le hizo la misma pregunta a cada valor: ¿cómo está representado, y qué obliga esa representación?" / NO ME GUSTA LA FORMA DE EXPRESAS "y no es un patrón de bits sobre el que puedas razonar directamente" / ESTE HECHO EXPLICA LAS CARACTERISTICAS DE LOS STRING EN LAS QUE SE BASA ESTE CAPITULO (sobre "Ese único hecho es el capítulo entero") / REDACTA MEJOR "por qué pegar texto dentro de un bucle es el clásico error de rendimiento del junior" / ESTE ARCHIVO EMPIEZA POR EXPLICAR LA INMUTABILIDAD.... (sobre "Esta es la ruta que sigue el archivo") | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
...
| NTH-0034 | 2026-09-08 | java/junior/02 | es | mecanismo | 1 | IMAGINO QUE TE REFIERES A QUE PARECE QUE NO HACE NADA SI NO SE ALMACENA EN UNA VARIABLE PORQUE SE PIERDE EL NUEVO OBJETO CREADO | unapplied | `_note-quality-standard.md` → `Anticipate-the-TODO pass` (mechanism before behaviour) | open |
