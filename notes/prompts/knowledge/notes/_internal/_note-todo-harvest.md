...
| NTH-0002 | 2026-09-02 | java/junior/01 | es | frase-sobrecargada | 14 | ES MALISIMA, MUY MAL EXPRESADA / PODRIA ESTAR UN POCO MAS CLARA / NO ME GUSTA LA FRASE "y cada uno pertenece al capítulo que tiene el vocabulario para explicarlo" / MUY MAL EXPRESADO LO DE QUE ES UN OBJETO SIQUIERA / MUY MALA FRASE EN ESPAÑOL ("En código de aplicación") / NI LA ESCALA QUE USAR, NO LO NECESITAN / DONDE ELEGIMOS LA ESCALA Y REDONDEO EN CASO DE QUERER IMPLEMENTARLO EN ALGUNO DE LOS OTROS TRES METODOS / MUY MAL EXPRESADO. ENTIENDO QUE A PARTIR DE .5 SE REDONDEA AL SUPERIOR Y POR DEBAJO DE .5 AL INFERIOR | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
| NTH-0003 | 2026-09-02 | java/junior/01 | es | floritura-literaria | 7 | ES UNA MALA EXPRESION / TAMPOCO HACE FALTA QUE NOMBRES QUE ES LO QUE TE ENSEÑAN EN EL COLEGIO | unapplied | `_note-quality-standard.md` → `Sentence-level register` (cut the literary flourish) | open |
...
| NTH-0005 | 2026-09-02 | java/junior/01 | es | termino-sin-presentar | 9 | UN FLAG??? / NO ENTIENDO LA FRASE "la cláusula de guarda a la entrada de un método" / NO USES "EL CALLOUT" / IMAGINO QUE QUEDA MEJOR "LA SECCION ANTERIOR" / NO SE LO QUE ES SOBRECARGA DE OPERADORES / ES LANZAR UNA EXCEPCION, LANZAR O MANEJAR YN ERROR | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
| NTH-0006 | 2026-09-02 | java/junior/01 | es | ejemplo-sin-senalar | 3 | ESTO ES OTRO EJEMPLO, PERO DEBES INDICARLO | missing | — | open |
| NTH-0007 | 2026-09-02 | java/junior/01 | es | referencia-ambigua | 15 | UNO DE ELLOS? UN OBJETO? UN BIT? / CUENTA LOS CHAR QUE TIENE UN STRING / PORQUE YO ENTIENDO QUE AQUI SE REFIERE EN REALIDAD A LOS METODOS QU SE USAN REALMENTE PARA COMAPARAR STRING / EN LOS EJEMPLOS DE ABAJO? TE REFIERES A LOS EJEMPLOS MAS ABAJO DE ESTE ARCHIVO? / ESA DIRECCION ESTA PERMITIDA / EN LUGAR DEL NUMERO REDONDEADO / DE CREAR VALORES QUE ALMACENAN DINERO / QUE SECCION DEL DINERO / COMPARA DOS BIGDECIMAL / POR ESO ESTOS METODOS | missing | — | open |
| NTH-0008 | 2026-09-02 | java/junior/01 | es | mecanismo | 15 | MUY MUY MAL EXPLICADO / NO ENTIENDO NADA DE "Para los siete tipos numéricos, ambas cosas coinciden…" / NO ENTIENDO: porque la multiplicación se ejecuta en `int` antes de que se considere siquiera la asignación / NO ENTIENDO "así que una clase nunca puede enseñarle a `<` a funcionar sobre ella" / COMO REDONDEAR Y LA ESCALA QUE USAR EN EL RESULTADO. MULTIPLY ADD SUBTRACT TIENE UN ARGUMENTOS MIENTRAS QUE DIVIDE RECIBE SIEMPRE 3 ARGUMENTOS / EL HALF_EVEN NO HE ENTENDIDO LA EXPLICACION | unapplied | `_note-quality-standard.md` → `Anticipate-the-TODO pass` (mechanism before behaviour) | open |
...
| NTH-0015 | 2026-09-02 | java/junior/01 | es | seccion-sin-entradilla | 3 | AQUI PUEDES INDICAR EN UNA BREVE FRASE QUE MAS ARRIBA YA VIMOS LOS TIPOS (EN UNA TABLA) Y QUE AHORA VAS A EXPLICAR … LOS TIPOS QUE NOS VAMOS A ENCONTRAR … EN EL DIA A DIA / AQUI SE PUEDE DECIR QUE LA SIGUIENTE OPCION ES ... | missing | — | open |
