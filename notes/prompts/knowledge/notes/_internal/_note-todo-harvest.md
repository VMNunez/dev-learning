...
| NTH-0039 | 2026-09-08 | java/junior/02 | es | lead-in-metafora | 1 | SE USA UN MISMO EJEMPLO PARA TODO EL ARCHIVO (sobre "**Un mismo ejemplo recorre todo el archivo.**") | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
