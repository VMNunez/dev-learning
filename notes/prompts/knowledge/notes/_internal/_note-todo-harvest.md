...
| NTH-0002 | 2026-09-02 | java/junior/01 | es | frase-sobrecargada | 23 | ES MALISIMA, MUY MAL EXPRESADA / PODRIA ESTAR UN POCO MAS CLARA / NO ME GUSTA LA FRASE "y cada uno pertenece al capítulo que tiene el vocabulario para explicarlo" / MUY MAL EXPRESADO LO DE QUE ES UN OBJETO SIQUIERA / MUY MALA FRASE EN ESPAÑOL ("En código de aplicación") / NI LA ESCALA QUE USAR, NO LO NECESITAN / DONDE ELEGIMOS LA ESCALA Y REDONDEO EN CASO DE QUERER IMPLEMENTARLO EN ALGUNO DE LOS OTROS TRES METODOS / MUY MAL EXPRESADO. ENTIENDO QUE A PARTIR DE .5 SE REDONDEA AL SUPERIOR Y POR DEBAJO DE .5 AL INFERIOR / AL NUMERO PAR MAS CERCANO / Y ESO PUEDE RESULTAR EN UNA APROXIMACION POR EXCESO O POR DEFECTO / ALMACENA VALORES EN EL MAPA … O GUARDA PARES CLAVE-VALOR EN EL MAPA / RECUPERA PARES CLAVE->VALOR BUSCANDO POR SU CLAVE / TAMBIEN AFECTA EN EL COMPORTAMIENTO DEL PUT / QUE POR EL MISMO MOTIVO / EN COMPARETO NO IMPORTA LA ESCALA / EL SEGUNDO PUT SOBRE UNA CLAVE QUE YA EXISTE LO QUE HACE ES SUSTITUIR LA QUE YA EXISTIA POR EL NUEVO PUT / LA FRASE NO ME GUSTA "Todo camino posible del código tiene que asignar la variable antes de que nada la lea" | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
...
| NTH-0005 | 2026-09-02 | java/junior/01 | es | termino-sin-presentar | 13 | UN FLAG??? / NO ENTIENDO LA FRASE "la cláusula de guarda a la entrada de un método" / NO USES "EL CALLOUT" / IMAGINO QUE QUEDA MEJOR "LA SECCION ANTERIOR" / NO SE LO QUE ES SOBRECARGA DE OPERADORES / ES LANZAR UNA EXCEPCION, LANZAR O MANEJAR YN ERROR / NO HEMOS VISTO EN NINGUN LADO LO QUE ES UN HASHMAP / DEBES HACER UNA BREVISIMA INTRODUCCION A LO QUE ES UN HASHMAP Y TREEMAP / IMAGIN QUE ESTOS DOS MAPAS SON MUY USADOS EN JAVA / UN SLOT ERA UN LUGAR EN LA MEMORIA | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
| NTH-0006 | 2026-09-02 | java/junior/01 | es | ejemplo-sin-senalar | 3 | ESTO ES OTRO EJEMPLO, PERO DEBES INDICARLO | missing | — | open |
| NTH-0007 | 2026-09-02 | java/junior/01 | es | referencia-ambigua | 25 | UNO DE ELLOS? UN OBJETO? UN BIT? / CUENTA LOS CHAR QUE TIENE UN STRING / PORQUE YO ENTIENDO QUE AQUI SE REFIERE EN REALIDAD A LOS METODOS QU SE USAN REALMENTE PARA COMAPARAR STRING / EN LOS EJEMPLOS DE ABAJO? TE REFIERES A LOS EJEMPLOS MAS ABAJO DE ESTE ARCHIVO? / ESA DIRECCION ESTA PERMITIDA / EN LUGAR DEL NUMERO REDONDEADO / DE CREAR VALORES QUE ALMACENAN DINERO / QUE SECCION DEL DINERO / COMPARA DOS BIGDECIMAL / POR ESO ESTOS METODOS / QUE EL DINERO LO GUARDE EN BIGDECIMAL Y LO COMPARE CON COMPARETO / ANTES DE GUARDARLA EN EL MAPA / SU ORDEN IMAGINO QUE SU COMPARETO / PIERDO LA ENTRADA EN EL TREEMAP / UN CAMPO DE UN OBJETO / LAS VARIABLES QUE SE DECLARAN DENTRO DE LA CLASE / DONDE VIVE CADA UNO? CADA QUE? / SE EXPLICITO. NO DIGAS CADA UNO / DENTRO DEL BLOQUE DE MEMORIA / POR EJEMPLO LA DEL STRING PARA EL NAME | missing | — | open |
...
| NTH-0022 | 2026-09-04 | java/junior/01 | es | consecuencia-abstracta | 3 | PORQUE SI HAGO GET(1.0) Y GET(1.00) SON DOS CLAVES DISTINTA / LO SUSTITUYE PORQUE TREEMAP USA COMPARETO / AÑADE PORQUE USA EQUAL | unapplied | `_note-quality-standard.md` → `Anticipate-the-TODO pass` | open |
