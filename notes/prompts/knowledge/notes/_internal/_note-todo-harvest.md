...
| NTH-0034 | 2026-09-08 | java/junior/02 | es | mecanismo | 3 | IMAGINO QUE TE REFIERES A QUE PARECE QUE NO HACE NADA SI NO SE ALMACENA EN UNA VARIABLE PORQUE SE PIERDE EL NUEVO OBJETO CREADO / ACUMULAR TEXTO IMAGINO QUE TE REFIERES A IR AÑADIENDO TENGO EN UN BUCLE SIN IR ACUMULANDO OBJETOS QUE NO SE USAN / NO ENTIENDO POR QUE DEL TEXTO HAY QUE SACAR DATOS EN ESE FLUJO | unapplied | `_note-quality-standard.md` → `Anticipate-the-TODO pass` (mechanism before behaviour) | open |
