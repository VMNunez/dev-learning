...
| NTH-0032 | 2026-09-08 | java/junior/02 | es | referencia-ambigua | 7 | UN STRING COMO UN NOMBRE DE USUARIO...ETC / UN JSON O EL BODY DE UN JSON / UNA URL, NO ME GUSTA "una ruta de URL" / UN LOG PARA DEPURAR ERRORES / A LO QUE VIMOS PARA LOS NÚMEROS O PARA LOS PRIMITIVOS O EN EL 01-VARIABLES-TIPOS / LA FORMA DE METER JSON O SQL, PERO DONDE ? / Y VICEVERSA? | missing | — | open |
...
| NTH-0034 | 2026-09-08 | java/junior/02 | es | mecanismo | 2 | IMAGINO QUE TE REFIERES A QUE PARECE QUE NO HACE NADA SI NO SE ALMACENA EN UNA VARIABLE PORQUE SE PIERDE EL NUEVO OBJETO CREADO / ACUMULAR TEXTO IMAGINO QUE TE REFIERES A IR AÑADIENDO TENGO EN UN BUCLE SIN IR ACUMULANDO OBJETOS QUE NO SE USAN | unapplied | `_note-quality-standard.md` → `Anticipate-the-TODO pass` (mechanism before behaviour) | open |
