...
| NTH-0029 | 2026-09-08 | java/junior/02 | es | frase-sobrecargada | 11 | NO ME GUSTA TU FORMA DE EXPRESAR "le hizo la misma pregunta a cada valor: ¿cómo está representado, y qué obliga esa representación?" / NO ME GUSTA LA FORMA DE EXPRESAS "y no es un patrón de bits sobre el que puedas razonar directamente" / ESTE HECHO EXPLICA LAS CARACTERISTICAS DE LOS STRING EN LAS QUE SE BASA ESTE CAPITULO (sobre "Ese único hecho es el capítulo entero") / REDACTA MEJOR "por qué pegar texto dentro de un bucle es el clásico error de rendimiento del junior" / ESTE ARCHIVO EMPIEZA POR EXPLICAR LA INMUTABILIDAD.... (sobre "Esta es la ruta que sigue el archivo") / LUEGO SE VEN EL CONJUNTOS DE METODOS QUE USARÁS EN EL DIA A DIA / PARA QUE PUEDAS LEER CODIGO JAVA CORRECTAMENTE, O DE FORMA SENCILLA / TRAS ELLO SE VERAN LOS LUGARES DONDE ESOS METODOS TE ENGAÑAN / DESPUES SE VERÁN LAS DOS FORMAS POSIBLES DE INTRODUCIR VALORES DENTRO DE ... / LUEGO SE VERAN LOS / LUEGO SE VERAN LAS CONVERSIONES TEXTO A NUMERO Y A LA INVERSA / Y CIERRA CON LA COMPARACION DE DOS STRING QUE SE VERAN EN OTRO CAPITULO | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
...
| NTH-0032 | 2026-09-08 | java/junior/02 | es | referencia-ambigua | 6 | UN STRING COMO UN NOMBRE DE USUARIO...ETC / UN JSON O EL BODY DE UN JSON / UNA URL, NO ME GUSTA "una ruta de URL" / UN LOG PARA DEPURAR ERRORES / A LO QUE VIMOS PARA LOS NÚMEROS O PARA LOS PRIMITIVOS O EN EL 01-VARIABLES-TIPOS / LA FORMA DE METER JSON O SQL, PERO DONDE ? | missing | — | open |
