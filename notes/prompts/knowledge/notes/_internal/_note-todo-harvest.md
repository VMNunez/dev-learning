...
| NTH-0002 | 2026-09-02 | java/junior/01 | es | frase-sobrecargada | 9 | ES MALISIMA, MUY MAL EXPRESADA / PODRIA ESTAR UN POCO MAS CLARA / NO ME GUSTA LA FRASE "y cada uno pertenece al capítulo que tiene el vocabulario para explicarlo" / MUY MAL EXPRESADO LO DE QUE ES UN OBJETO SIQUIERA / MUY MALA FRASE EN ESPAÑOL ("En código de aplicación") | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
