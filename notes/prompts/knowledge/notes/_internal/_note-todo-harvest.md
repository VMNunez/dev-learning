...
| NTH-0002 | 2026-09-02 | java/junior/01 | es | frase-sobrecargada | 11 | ES MALISIMA, MUY MAL EXPRESADA / PODRIA ESTAR UN POCO MAS CLARA / NO ME GUSTA LA FRASE "y cada uno pertenece al capítulo que tiene el vocabulario para explicarlo" / MUY MAL EXPRESADO LO DE QUE ES UN OBJETO SIQUIERA / MUY MALA FRASE EN ESPAÑOL ("En código de aplicación") | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
| NTH-0003 | 2026-09-02 | java/junior/01 | es | floritura-literaria | 6 | ES UNA MALA EXPRESION | unapplied | `_note-quality-standard.md` → `Sentence-level register` (cut the literary flourish) | open |
...
| NTH-0012 | 2026-09-02 | java/junior/01 | es | codigo-no-a-la-vista | 4 | ME GUSTARIA VER EL CODIGO JUSTO ENCIMA DEL PARRAFO PARA TENERLO A LA VISTA / PARA VER BIEN LO DE THIS Y OTHER … PONER THIS.COMPARETO(NEW BIGDECIMAL()) COMO EJEMPLO | missing | — | open |
...
| NTH-0016 | 2026-09-02 | java/junior/01 | es | afirmacion-absoluta-imprecisa | 2 | SIEMPRE NO CREO … te refieres a los literales numericos enteros | missing | — | open |
