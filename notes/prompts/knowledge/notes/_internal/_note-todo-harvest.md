...
| NTH-0002 | 2026-09-02 | java/junior/01 | es | frase-sobrecargada | 13 | ES MALISIMA, MUY MAL EXPRESADA / PODRIA ESTAR UN POCO MAS CLARA / NO ME GUSTA LA FRASE "y cada uno pertenece al capítulo que tiene el vocabulario para explicarlo" / MUY MAL EXPRESADO LO DE QUE ES UN OBJETO SIQUIERA / MUY MALA FRASE EN ESPAÑOL ("En código de aplicación") / NI LA ESCALA QUE USAR, NO LO NECESITAN / DONDE ELEGIMOS LA ESCALA Y REDONDEO EN CASO DE QUERER IMPLEMENTARLO EN ALGUNO DE LOS OTROS TRES METODOS | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
