...
| NTH-0005 | 2026-09-02 | java/junior/01 | es | termino-sin-presentar | 10 | UN FLAG??? / NO ENTIENDO LA FRASE "la cláusula de guarda a la entrada de un método" / NO USES "EL CALLOUT" / IMAGINO QUE QUEDA MEJOR "LA SECCION ANTERIOR" / NO SE LO QUE ES SOBRECARGA DE OPERADORES / ES LANZAR UNA EXCEPCION, LANZAR O MANEJAR YN ERROR / NO HEMOS VISTO EN NINGUN LADO LO QUE ES UN HASHMAP | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
