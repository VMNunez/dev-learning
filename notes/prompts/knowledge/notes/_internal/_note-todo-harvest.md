...
| NTH-0029 | 2026-09-08 | java/junior/02 | es | frase-sobrecargada | 2 | NO ME GUSTA TU FORMA DE EXPRESAR "le hizo la misma pregunta a cada valor: ¿cómo está representado, y qué obliga esa representación?" / NO ME GUSTA LA FORMA DE EXPRESAS "y no es un patrón de bits sobre el que puedas razonar directamente" | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
