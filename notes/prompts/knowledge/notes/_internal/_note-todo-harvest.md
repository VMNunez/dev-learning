...
| NTH-0005 | 2026-09-02 | java/junior/01 | es | termino-sin-presentar | 7 | UN FLAG??? / NO ENTIENDO LA FRASE "la cláusula de guarda a la entrada de un método" / NO USES "EL CALLOUT" / IMAGINO QUE QUEDA MEJOR "LA SECCION ANTERIOR" | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
| NTH-0006 | 2026-09-02 | java/junior/01 | es | ejemplo-sin-senalar | 3 | ESTO ES OTRO EJEMPLO, PERO DEBES INDICARLO | missing | — | open |
| NTH-0007 | 2026-09-02 | java/junior/01 | es | referencia-ambigua | 8 | UNO DE ELLOS? UN OBJETO? UN BIT? / CUENTA LOS CHAR QUE TIENE UN STRING / PORQUE YO ENTIENDO QUE AQUI SE REFIERE EN REALIDAD A LOS METODOS QU SE USAN REALMENTE PARA COMAPARAR STRING / EN LOS EJEMPLOS DE ABAJO? TE REFIERES A LOS EJEMPLOS MAS ABAJO DE ESTE ARCHIVO? / ESA DIRECCION ESTA PERMITIDA / EN LUGAR DEL NUMERO REDONDEADO / DE CREAR VALORES QUE ALMACENAN DINERO | missing | — | open |
| NTH-0008 | 2026-09-02 | java/junior/01 | es | mecanismo | 8 | MUY MUY MAL EXPLICADO / NO ENTIENDO NADA DE "Para los siete tipos numéricos, ambas cosas coinciden…" / NO ENTIENDO: porque la multiplicación se ejecuta en `int` antes de que se considere siquiera la asignación | unapplied | `_note-quality-standard.md` → `Anticipate-the-TODO pass` (mechanism before behaviour) | open |
