...
| NTH-0032 | 2026-09-08 | java/junior/02 | es | referencia-ambigua | 9 | UN STRING COMO UN NOMBRE DE USUARIO...ETC / UN JSON O EL BODY DE UN JSON / UNA URL, NO ME GUSTA "una ruta de URL" / UN LOG PARA DEPURAR ERRORES / A LO QUE VIMOS PARA LOS NÚMEROS O PARA LOS PRIMITIVOS O EN EL 01-VARIABLES-TIPOS / LA FORMA DE METER JSON O SQL, PERO DONDE ? / Y VICEVERSA? / IMAGINO QUE CONVERTIR LOS DATOS INTRODUCIDOS EN TEXTO LEGIBLE / IMAGINO QUE LOS DATOS DEL EMPLEADO VIENEN DE UNA BASE DE DATOS | missing | — | open |
