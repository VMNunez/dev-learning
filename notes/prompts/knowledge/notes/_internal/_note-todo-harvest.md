...
| NTH-0020 | 2026-09-04 | java/junior/01 | es | enumeracion-incompleta | 5 | NOMBRAS HALF-UP Y HALF-EVEN PERO NO SE SI HAY UN HALF-DOWN O ALGO ASI … O SI NO SE USA / Y LOS OBJETOS AL HEAP / PERO FLOAT A INT Y DOUBLE A LONG NO HAY PERDIDA / INDICAR QUE LA SOLUCION ES CONVERTIR EN DOUBLE EL PRIMER OPERANDO / MIENTRAS QUE List<Integer> ES CORRECTO | missing | — | open |
...
| NTH-0034 | 2026-09-08 | java/junior/02 | es | mecanismo | 4 | IMAGINO QUE TE REFIERES A QUE PARECE QUE NO HACE NADA SI NO SE ALMACENA EN UNA VARIABLE PORQUE SE PIERDE EL NUEVO OBJETO CREADO / ACUMULAR TEXTO IMAGINO QUE TE REFIERES A IR AÑADIENDO TENGO EN UN BUCLE SIN IR ACUMULANDO OBJETOS QUE NO SE USAN / NO ENTIENDO POR QUE DEL TEXTO HAY QUE SACAR DATOS EN ESE FLUJO / ME GENERA UNA DUDA EL CODIGO DE ARRIBA ... ESA VARIABLE YA EXISTIA ... CAMBIA ESA DIRECCION Y AHORA APUNTA AL NUEVO OBJETO | unapplied | `_note-quality-standard.md` → `Anticipate-the-TODO pass` (mechanism before behaviour) | open |
| NTH-0035 | 2026-09-08 | java/junior/02 | es | termino-traducido-no-usado | 2 | PONLO TAMBIEN EN INGLES ESE VACIO Y BLANCO / PONLO EN INGLES TAMBIEN PORQUE TENGO LA INTUICION DE QUE ES UNA PALABRA USADA EN INGLES | missing | — | open |
| NTH-0036 | 2026-09-08 | java/junior/02 | es | termino-sin-presentar | 2 | PON EL NOMBRE, IMAGINO QUE SE LLAMA CONCATENAR, CONCATENANDOD CON + O USANDO EL METODO / LA ASIGNACION (sobre "se te olvidó el `=`") | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
| NTH-0037 | 2026-09-08 | java/junior/02 | es | conector-repetido | 1 | USA TODO EL TIEMPO "LUEGO" Y "LUEGO" Y LUEGO. MODIFICA ESO SOLAMENTE PARA QUE LOS CONECTORES SEAN MEJORES | missing | — | open |
| NTH-0038 | 2026-09-08 | java/junior/02 | es | enumeracion-incompleta | 1 | Y DE NUMERO A TEXTO (sobre "texto a número y a la inversa") | missing | — | open |
| NTH-0039 | 2026-09-08 | java/junior/02 | es | lead-in-metafora | 2 | SE USA UN MISMO EJEMPLO PARA TODO EL ARCHIVO (sobre "**Un mismo ejemplo recorre todo el archivo.**") / ESTA CARACTERISTICA INFLUYE A TODA LA CLASE STRING, NO SOLAMENTE CON EL METODO TOUPPERCASE | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
