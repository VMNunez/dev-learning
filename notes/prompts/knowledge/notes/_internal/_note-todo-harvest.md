...
| NTH-0022 | 2026-09-04 | java/junior/01 | es | consecuencia-abstracta | 4 | PORQUE SI HAGO GET(1.0) Y GET(1.00) SON DOS CLAVES DISTINTA / LO SUSTITUYE PORQUE TREEMAP USA COMPARETO / AÑADE PORQUE USA EQUAL / PORQUE CONTENDRIA LOS VALORES DEL OBJETO ANTERIOR | unapplied | `_note-quality-standard.md` → `Anticipate-the-TODO pass` | open |
