...
| NTH-0029 | 2026-09-08 | java/junior/02 | es | frase-sobrecargada | 4 | NO ME GUSTA TU FORMA DE EXPRESAR "le hizo la misma pregunta a cada valor: ¿cómo está representado, y qué obliga esa representación?" / NO ME GUSTA LA FORMA DE EXPRESAS "y no es un patrón de bits sobre el que puedas razonar directamente" / ESTE HECHO EXPLICA LAS CARACTERISTICAS DE LOS STRING EN LAS QUE SE BASA ESTE CAPITULO (sobre "Ese único hecho es el capítulo entero") / REDACTA MEJOR "por qué pegar texto dentro de un bucle es el clásico error de rendimiento del junior" | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
