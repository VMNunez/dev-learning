...
| NTH-0002 | 2026-09-02 | java/junior/01 | es | frase-sobrecargada | 24 | ES MALISIMA, MUY MAL EXPRESADA / PODRIA ESTAR UN POCO MAS CLARA / NO ME GUSTA LA FRASE "y cada uno pertenece al capítulo que tiene el vocabulario para explicarlo" / MUY MAL EXPRESADO LO DE QUE ES UN OBJETO SIQUIERA / MUY MALA FRASE EN ESPAÑOL ("En código de aplicación") / NI LA ESCALA QUE USAR, NO LO NECESITAN / DONDE ELEGIMOS LA ESCALA Y REDONDEO EN CASO DE QUERER IMPLEMENTARLO EN ALGUNO DE LOS OTROS TRES METODOS / MUY MAL EXPRESADO. ENTIENDO QUE A PARTIR DE .5 SE REDONDEA AL SUPERIOR Y POR DEBAJO DE .5 AL INFERIOR / AL NUMERO PAR MAS CERCANO / Y ESO PUEDE RESULTAR EN UNA APROXIMACION POR EXCESO O POR DEFECTO / ALMACENA VALORES EN EL MAPA … O GUARDA PARES CLAVE-VALOR EN EL MAPA / RECUPERA PARES CLAVE->VALOR BUSCANDO POR SU CLAVE / TAMBIEN AFECTA EN EL COMPORTAMIENTO DEL PUT / QUE POR EL MISMO MOTIVO / EN COMPARETO NO IMPORTA LA ESCALA / EL SEGUNDO PUT SOBRE UNA CLAVE QUE YA EXISTE LO QUE HACE ES SUSTITUIR LA QUE YA EXISTIA POR EL NUEVO PUT / LA FRASE NO ME GUSTA "Todo camino posible del código tiene que asignar la variable antes de que nada la lea" / COMENZARIAN VALIENDO LOS VALORES QUE TUVIERA ALMACENADO EL OBJETO ANTERIOR | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
| NTH-0003 | 2026-09-02 | java/junior/01 | es | floritura-literaria | 11 | ES UNA MALA EXPRESION / TAMPOCO HACE FALTA QUE NOMBRES QUE ES LO QUE TE ENSEÑAN EN EL COLEGIO / LOS MAPAS SE VEN EN... / NO ME GUSTA LO DE LOS GOBIERNAN / NO ME GUSTA "deshacer aquí un atajo fácil" / "se lleva" ELIMINA | unapplied | `_note-quality-standard.md` → `Sentence-level register` (cut the literary flourish) | open |
...
| NTH-0020 | 2026-09-04 | java/junior/01 | es | enumeracion-incompleta | 2 | NOMBRAS HALF-UP Y HALF-EVEN PERO NO SE SI HAY UN HALF-DOWN O ALGO ASI … O SI NO SE USA / Y LOS OBJETOS AL HEAP | missing | — | open |
...
| NTH-0022 | 2026-09-04 | java/junior/01 | es | consecuencia-abstracta | 5 | PORQUE SI HAGO GET(1.0) Y GET(1.00) SON DOS CLAVES DISTINTA / LO SUSTITUYE PORQUE TREEMAP USA COMPARETO / AÑADE PORQUE USA EQUAL / PORQUE CONTENDRIA LOS VALORES DEL OBJETO ANTERIOR / NO ENTIENDO "no lo hace quien libera, sino quien reserva" | unapplied | `_note-quality-standard.md` → `Anticipate-the-TODO pass` | open |
