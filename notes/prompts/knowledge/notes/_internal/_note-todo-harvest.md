...
| NTH-0036 | 2026-09-08 | java/junior/02 | es | termino-sin-presentar | 1 | PON EL NOMBRE, IMAGINO QUE SE LLAMA CONCATENAR, CONCATENANDOD CON + O USANDO EL METODO | unapplied | `_note-quality-standard.md` → `Sentence-level register` | open |
