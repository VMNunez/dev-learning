...
| Prompt | Purpose |
|--------|---------|
| `notes/prompts/projects/plan/plan-audit.md` | Plans the project — writes the PLANNING.md that is the single source of truth for what is built and why |
| `notes/prompts/projects/readme/readme-review-prompt.md` | Reviews and fixes all READMEs — single source of README rules and format |
...
This file was generated by `notes/prompts/projects/plan/plan-audit.md`. It is the single source
...
`plan-audit`). Projects 01–06 (Angular-only) use the old format with no numbered sections —
