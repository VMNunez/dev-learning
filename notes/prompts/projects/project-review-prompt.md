...
## Step 1 — Read PLANNING.md first

Before reviewing any code, read `{PROJECT_PATH}/PLANNING.md`.
...
- Tests — at least one per service from project 07 onwards
...
- 05: task manager — Angular Material, MatTable, MatDialog, CRUD, coordinator pattern
...
README rules and format are defined in `notes/prompts/projects/readme-review-prompt.md`.
That prompt is the single source of README truth and fixes issues directly.

Run `readme-review-prompt.md` in a separate conversation before running this review.
