...
- **`interview-prep/projects/en/*.md`** — written by `portfolio-audit`'s author + reviewer, and by
...
- **`interview-prep/projects/es/*.md`** — written by `portfolio-audit`'s translator, from the `en/`
  ...
  notes family's stage C does. That row still owes it priority markers and the three `[studied]`
  rulings.
