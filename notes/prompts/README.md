...
| `/readme-audit` → `readme-audit` | `PROJECT_PATH=path\|all` | O, author+reviewer+reader-effect judge per README · agent | run-first nothing; as project gate **G5** it runs after every High from G3/G4 is fixed; auto-commits the project README work in one commit (authorized 2026-08-29) |
