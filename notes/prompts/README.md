...
`notes-plan-prompt.md` / `notes-inspect-prompt.md` / `notes-write-prompt.md` / `notes-review-prompt.md`,
...
coverage-prompt / coverage-audit ─► notes/coverage.md
        │
        ├─► notes-audit (folder|file) ─► [plan] → [inspect per existing file] → per file: author + reviewer subagents ─► notes/*.md ─┐
