...
Not every `AGENTS.md` in this repository is an adapter. Angular apps from project 07 onward carry a
`AGENTS.md` generated by the Angular CLI at `projects/NN-*/frontend/<app>/`. That file is Angular's own
