...
- 2026-09-01 · **[Low]** `[frontend]` — `How to run` path corrected to `projects/` after the repository reorg → README How to run; no coverage mark — documentation only, no code written
