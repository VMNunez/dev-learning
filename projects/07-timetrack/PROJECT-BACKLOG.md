...
- 2026-07-30 · **[Low]** `[backend]` — entry-id existence oracle closed: a non-owned entry is 404, not 403 → security + java coverage/junior (new bullets, ✅ 07), PLANNING §8 status ruling + §10/§11/§21, backend README, PROGRESS
