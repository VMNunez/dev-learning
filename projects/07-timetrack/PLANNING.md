...
2026-09-11 in `2fd8891e` — so no High or Medium was open until 2026-09-21, when **the frontend High and Medium above were raised** — both closed the same day, so no backlog task holds G7. The frontend tier has never been reviewed, so G4's `review-audit` run can still reopen it.
