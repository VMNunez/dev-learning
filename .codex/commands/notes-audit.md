---
description: Build or audit study notes for a topic or a single file (orchestrator, runs inside Codex)
...
Read `notes/prompts/knowledge/notes/notes-audit.md` and execute it in full as the hands-off orchestrator it describes, running inside Codex.
