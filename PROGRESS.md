...
| Java | 0/121 (0%) | 0/14 (0%)* | 0/5 (0%)* |
| Architecture | 0/66 (0%) | 0/15 (0%)* | 0/5 (0%)* |
| Security | 0/95 (0%) | 0/10 (0%)* | 0/5 (0%)* |
...
All cells are 0% because the `✅ NN` marker only went live on 2026-07-30: the backfill of projects
01–07 has not started. An unmarked bullet here means "not yet marked", not "not yet applied", until
that backfill lands.
