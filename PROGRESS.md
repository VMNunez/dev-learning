...
| Security | Junior — building | Notes plan stale (0/13 complete); junior Q&A pending full audit | Guards/interceptors in project 06; JWT/RBAC and query-input allow-listing in project 07 | Refresh the junior notes plan |
