...
|---|---|---|---|---|
| Angular | Junior — building | Notes plan stale (0/17 complete); junior Q&A pending full audit | Projects 01–06, including a detail page driven by a route-param signal and an `effect()` whose cleanup cancels the in-flight request when the router reuses the component instance; project 07 frontend pending | Refresh the junior notes plan |
...
|---|---|---|---|
| Angular | 74/132 (56%) | 0/12 (0%)* | 0/6 (0%)* |
...
| **Total** | **557/1396 (40%)** | **8/176 (5%)** | **0/62 (0%)** |
