...
|---|---|---|---|
| Angular | 42/116 (36%) | 0/13 (0%)* | 0/6 (0%)* |
| Angular Material | 0/73 (0%) | 0/12 (0%)* | 0/3 (0%)* |
| Spring Boot | 78/141 (55%) | 1/16 (6%)* | 0/5 (0%)* |
| Java | 46/125 (37%) | 0/14 (0%)* | 0/5 (0%)* |
| Architecture | 30/66 (45%) | 0/15 (0%)* | 0/5 (0%)* |
| Security | 37/96 (39%) | 0/10 (0%)* | 0/5 (0%)* |
| TypeScript | 15/82 (18%) | 0/15 (0%)* | 0/4 (0%)* |
| SQL | 13/135 (10%) | 0/13 (0%)* | 0/5 (0%)* |
| JavaScript | 24/129 (19%) | 0/13 (0%)* | 0/4 (0%)* |
| CSS | 40/75 (53%)* | 0/6 (0%)* | 0/4 (0%)* |
| Git | 0/86 (0%)* | 0/5 (0%)* | 0/4 (0%)* |
| General | 25/108 (23%) | 0/10 (0%)* | 0/5 (0%)* |
| **Total** | **350/1232 (28%)** | **1/142 (1%)** | **0/55 (0%)** |
...
04 and the **backend** of 07 have been backfilled; 05, 06 and the Angular tier of 07 have not. An
unmarked bullet in a topic those projects would touch still means "not yet marked", not "not yet
applied". The topics with no backfilled project at all — Angular Material, Git — read 0% for that reason.
