...
Personal learning repository — Angular, Java, Spring Boot, SQL, CSS.
Notes, exercises, and projects built while studying full-stack development.

**Previous experience:** React · Node.js · Express · TypeScript · Tailwind

---

## Angular

Six projects, each focused on a specific set of concepts — starting from components and signals, and building up to guards, lazy loading, interceptors, and enterprise architecture patterns.
...
Projects that combine all the layers — Spring Boot REST API, PostgreSQL, and Angular — to learn how a real application fits together end to end.

| # | Project | Stack | Key concepts | Status |
|---|---------|-------|-------------|--------|
| 07 | [Finance tracker](projects/07-timetrack/) | Angular · Spring Boot · PostgreSQL · Docker | Full-stack REST API, JWT auth, Spring Data JPA, Hibernate, Docker Compose | In progress |
