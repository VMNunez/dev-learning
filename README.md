...
| 05 | [Task manager](angular/05-task-manager/) | Angular · Angular Material | Angular Material, MatTable, MatDialog, reactive forms, CRUD, coordinator pattern, multi-filter, localStorage | Coming soon |
