...
Not every `CLAUDE.md` in this repository is an adapter. Angular apps from project 07 onward carry one
generated by the Angular CLI at `projects/NN-*/frontend/<app>/.claude/CLAUDE.md`. That file is Angular's own
